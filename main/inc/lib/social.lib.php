...
//                    $html .= '<a href="'.api_get_path(WEB_PATH).'main/auth/profile.php">('.get_lang('EditProfile').')</a>';
        ...
        if (!in_array($show, array('shared_profile', 'groups', 'group_edit', 'member_list','waiting_list','invite_friends'))) {
            ...
            $html .= '<li class="'.$active.'"><a href="'.api_get_path(WEB_PATH).'main/social/whereiam.php">'.Display::return_icon('instant_message-new.png',get_lang('Messages'),array()).get_lang('WhereIAm').$count_unread_message.'</a></li>';
