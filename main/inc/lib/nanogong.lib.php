...
class Nanogong {
	...
	*/
    ...
    public function disableUpload()
    {
        ...
        return isset($_configuration['nanogong_disable_upload']) ? $_configuration['nanogong_disable_upload'] : false;
    }
	...
	function return_form($message = null)
    {
		...
		$preview_file = Display::div(
            $this->show_audio_file(true, true),
        ...
        $html .= '<param name="ShowSaveButton" value="true" />'; //you can save in local computer | (default true)
        $html .= '<param name="ShowSpeedButton" value="false" />'; // default true
		//echo '<param name="ShowAudioLevel" value="false" />'; //  it displays the audiometer | (default true)
		$html .= '<param name="ShowTime" value="true" />'; // default false
		...
		$html .= '<div style="display:none" id="status_ok" class="confirmation-message"></div>
		          <div style="display:none" id="status_warning" class="warning-message"></div>';
