...
$CategoryDestinations = "Destinos de categorías";
$ProgressiveAdaptive = "Progresivo / Adaptativo";
$LevelReachedX = "Nivel alcanzado: <strong>%s</strong>";
$ResultHashX = "Identificador único: <code>%s</code>";
$CategoryDestinationsSaved = "Destinos de categorías guardados.";
$DestinationUrl = "URL para el punto de entrada";
$LevelReachedInQuiz = "Nivel alcanzado en examen";
$TheQuizResultsWereSentToYourEmail = "Los resultados del examen fueron enviados a tu correo electrónico.";
$OneCategoryPerPage = "Una categoría por página";
$QuizCategoryDurationInMinutes = "Duración de la categoria (en minutos)";
?>
