...
$sessionNameFieldId = 4; //change to suit the field you expect (here 4 = 'horario' extra field)
...
$sql = "SELECT id, option_display_text FROM $ts WHERE field_id = ".$sessionNameFieldId;
echo $sql."\n";
