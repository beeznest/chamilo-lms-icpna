...
/* Register WSGetKidsPlexFinalScore function */
// Register the data structures used by the service
$server->wsdl->addComplexType(
    'getKidsPlexFinalScore',
    'complexType',
    'struct',
    'all',
    '',
...
// Register the method to expose
$server->register('WSGetKidsPlexFinalScore',		// method name
    array('getKidsPlexFinalScore' => 'tns:getKidsPlexFinalScore'),	// input parameters
    array('return' => 'tns:result_getKidsPlexFinalScore'),				// output parameters
    'urn:WSRegistration',						// namespace
    'urn:WSRegistration#WSGetKidsPlexFinalScore',	// soapaction
    'rpc',										// style
    'encoded',									// use
    'This service returns the results of the final exam for the given student, course and session'				// documentation
);

// define the method WSGetKidsPlexFinalScore
/**
 * returns the results of the kid plex exam for the given student, course and session
 * @param $params
 * @return array|null|soap_fault Returns result as a pure integer percentage
 */
function WSGetKidsPlexFinalScore($params) {
    ...
    require_once api_get_path(SYS_CODE_PATH) . 'exercice/exercise.lib.php';
    $score = getKidPlexFinalScore($cid, $sid);
...
$server->wsdl->addComplexType(
    ...
    array(
        'original_session_id_value' => array('name' => 'original_session_id_value', 'type' => 'xsd:string'),
        'result' => array('name' => 'result', 'type' => 'xsd:array')
    )
);
...
$server->wsdl->addComplexType(
    ...
    array(
        ...
        'score' => array('name' => 'score', 'type' => 'xsd:string'),
        'c_id' => array('name' => 'c_id', 'type' => 'xsd:string'),
