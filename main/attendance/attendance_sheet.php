...
$(document).ready(function() {
    ...
    <div class="attendance-sheet-content" style="width:100%;background-color:#E1E1E1;margin-top:20px;">
        <div class="divTableWithFloatingHeader attendance-users-table" style="width:39%;float:left;margin:0px;padding:0px;">
            <table class="tableWithFloatingHeader data_table" width="100%">
                ...
                <tr class="tableFloatingHeaderOriginal" >
                    ...
                    <th width="120px"><?php echo get_lang('FirstName')?></th>
                    <th width="75px"><?php echo get_lang('AttendancesFaults')?></th>
                </tr>
                </thead>
        ...
        echo '<div class="divTableWithFloatingHeader attendance-calendar-table" style="margin:0px;padding:0px;float:left;width:61%;overflow:auto;overflow-y:hidden;">';
        ...
        if (count($attendant_calendar) > 0 ) {
            foreach ($attendant_calendar as $calendar) {
                ...
                if (!empty($calendar['done_attendance'])){
                    $datetime = '<font color="blue" class="attendance-sheet-date-label">'.$datetime.'</font>';
                }
                ...
                $result .= '<center><div style="width:35px;">'.$datetime.'<br />';
