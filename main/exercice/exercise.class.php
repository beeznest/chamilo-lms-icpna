            ...
            if (api_is_allowed_to_session_edit()) {
                ...
                if ($this->type == ONE_PER_PAGE) {
                    if ($questionNum != 1) {
                        ...
                        $all_button .= '<a class="btn" href="javascript://" onclick="previous_question_and_save('.$prev_question.', '.$question_id.' );">'.get_lang(
                            'PreviousQuestion'
                        ).'</a>';
                    }
                    ...
                    if (!empty($questions_in_media)) {
                        ...
                        $all_button .= '&nbsp;<a class="'.$class.'" href="javascript://" onclick="save_question_list('.$questions_in_media.');">'.$label.'</a>';
                    } else {
                        $all_button .= '&nbsp;<a class="'.$class.'" href="javascript://" onclick="save_now('.$question_id.');">'.$label.'</a>';
                    }
                    ...
                    $all_button = '&nbsp;<a class="'.$class.'" href="javascript://" onclick="validate_all();">'.$all_label.'</a>';
