...
switch ($action) {
    ...
    case 'edit':
        ...
        $defaults['answerType'] = MEDIA_QUESTION;
...
$action_links = 'function action_formatter(cellvalue, options, rowObject) {
    ...
    '&nbsp;<a onclick="javascript:if(!confirm('."\'".addslashes(api_htmlentities(get_lang("ConfirmYourChoice"),
        ENT_QUOTES))."\'".')) return false;"  href="?sec_token='.$token.'&action=delete&id=\'+options.rowId+\'">'
...
$interbreadcrumb[] = array("url" => "exercice.php", "name" => get_lang('Exercises'));

Display::display_header(get_lang('Media'));

echo Display::toolbarAction('media_action', $items);
